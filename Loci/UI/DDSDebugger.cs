...
public class DDSDebugger
{
    public void DrawDDSDebug<T>(string label, DynamicDrawSystem<T> dds) where T : class
    {
        ...
        CkGui.SeparatorSpaced(LociCol.Gold.Uint());
    }

    public void DrawFolderMap<T>(DynamicDrawSystem<T> dds) where T : class
    {
    ...
    public void DrawFolderGroup<T>(DynamicDrawSystem<T> dds, IDynamicFolderGroup<T> group) where T : class
    {
    ...
    public void DrawFolder<T>(DynamicDrawSystem<T> dds, IDynamicFolder<T> folder) where T : class
    {
    ...
    public void DrawFolderInfo<T>(IDynamicCollection<T> folder) where T : class
    {
        // Initial details about the folder.
